...
(* OASIS_START *)
(* DO NOT EDIT (digest: c19107a6c0bd06f3b78170927f0c6ba5) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = ["Stmt_piqi"; "Stmt_piqi_ext"];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API documentation for bap-types";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\027\128¤5§±p\159Í¾\030Æað$\152";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
